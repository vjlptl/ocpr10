...
class performance_evaluator():
    ...
    def evaluate_entities_performance(self):
        ...
        for entity in self.entities_name:
            ...
            y_pred_dict[entity] = []
        correct_preds = []
        print("--- evaluate entities performance 1---")
        print("Initialise les listes")
        print(y_true_dict)
        print(y_pred_dict)
        print(correct_preds)
        ...
        for turn in self.ground_truth:
            ...
            print("\n--- evaluate entities performance 2---")
            print(turn)
            ...
            print("\n--- evaluate entities performance 3---")
            print(y_true_dict)
            print(y_pred_dict)
            print(correct_preds)
    ...
    def build_dictionnaries(self, turn):
        ...
        print("----Build dictionnaries 1----")
        print("Récupère les entities des grounds truths")
        print(turn["entities"])
        for i in turn["entities"]:
            print("----Build dictionnaries 2----")
            print(i)
            ...
            if entity_name == 'budget':
                ground_truth_dict[entity_name] = entity_value.replace(' ', '')
            else:
        ...
        try:  # if there is no entity found, "$instance" key doesn't exist
            ...
            pass
        print("----Build dictionnaries 3----")
        print("renvoies les listes")
        print(ground_truth_dict)
        print(prediction_dict)
